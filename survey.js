                  ...
                  (answer6) => {
                    ...
                    rl.question(
                      ...
                      (answer7) => {
                        ...
                        console.log(
                          `${answer1} loves listening to ${answer3} while ${answer2}, devouring ${answer5} for ${answer4}, prefers ${answer6} over any other sport, and is amazing at ${answer7} at inopportune times.`
                        );
                        rl.close();
                      }
                    );
